...
const (
	AuthService_Register_FullMethodName = "/voice.AuthService/Register"
	AuthService_Login_FullMethodName    = "/voice.AuthService/Login"
)
...
const (
	ChannelService_ListChannels_FullMethodName  = "/voice.ChannelService/ListChannels"
	ChannelService_JoinChannel_FullMethodName   = "/voice.ChannelService/JoinChannel"
	ChannelService_CreateChannel_FullMethodName = "/voice.ChannelService/CreateChannel"
)
...
var ChannelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "voice.ChannelService",
...
const (
	AdminService_SetAdminStatus_FullMethodName = "/voice.AdminService/SetAdminStatus"
	AdminService_ListUsers_FullMethodName      = "/voice.AdminService/ListUsers"
)
...
type AdminServiceClient interface {
	SetAdminStatus(ctx context.Context, in *SetAdminStatusRequest, opts ...grpc.CallOption) (*SetAdminStatusResponse, error)
...
func (c *adminServiceClient) SetAdminStatus(ctx context.Context, in *SetAdminStatusRequest, opts ...grpc.CallOption) (*SetAdminStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AdminServiceServer interface {
	SetAdminStatus(context.Context, *SetAdminStatusRequest) (*SetAdminStatusResponse, error)
...
func (UnimplementedAdminServiceServer) SetAdminStatus(context.Context, *SetAdminStatusRequest) (*SetAdminStatusResponse, error) {
...
func _AdminService_SetAdminStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).SetAdminStatus(ctx, req.(*SetAdminStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "voice.AdminService",
